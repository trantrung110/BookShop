...
//        => optionsBuilder.UseSqlServer("Server=.;Database=BookShop;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BanBe>(entity =>
        {
            ...
            entity.HasOne(d => d.MaHhNavigation).WithMany(p => p.BanBes)
                ...
                .HasConstraintName("FK_QuangBa_Book");
        ...
        modelBuilder.Entity<Book>(entity =>
        {
            ...
            entity.HasOne(d => d.MaLoaiNavigation).WithMany(p => p.Books)
                .HasForeignKey(d => d.MaLoai)
                .HasConstraintName("FK_Products_Categories");

            entity.HasOne(d => d.MaNccNavigation).WithMany(p => p.Books)
        ...
        modelBuilder.Entity<YeuThich>(entity =>
        {
            ...
            entity.HasOne(d => d.MaHhNavigation).WithMany(p => p.YeuThiches)
                .HasForeignKey(d => d.MaHh)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_YeuThich_Book");
